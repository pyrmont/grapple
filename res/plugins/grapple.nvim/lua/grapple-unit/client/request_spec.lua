...
local function _3_()
  local function _4_()
    local sent_msg = nil
    local sent_action = nil
    local conn
    local function _5_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
    ...
    return assert.equals(opts.action, sent_action)
  end
...
local function _7_()
  ...
  local function _11_()
    ...
    local sent_action = nil
    local conn
    local function _12_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
    ...
    request["sess-end"](conn, opts)
    assert.equals("sess.end", sent_msg.op)
    return assert.is_nil(sent_action)
  end
...
local function _13_()
  local function _14_()
    ...
    local sent_action = nil
    local conn
    local function _15_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
...
local function _17_()
  local function _18_()
    ...
    local sent_action = nil
    local conn
    local function _19_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
...
local function _21_()
  local function _22_()
    ...
    local sent_action = nil
    local conn
    local function _23_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
...
local function _28_()
  ...
  local function _30_()
    ...
    local sent_action = nil
    local conn
    local function _31_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
    ...
    assert.equals(opts.action, sent_action)
    assert.equals(1, #log_calls)
...
local function _39_()
  local function _40_()
    ...
    local sent_action = nil
    local conn
    local function _41_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
...
local function _50_()
  local function _51_()
    ...
    local sent_action = nil
    local conn
    local function _52_(msg, action)
      sent_msg = msg
      sent_action = action
      return nil
    end
